...
ARC_NAME=${LIB_NAME}_0.0~${SRC_VER}.orig.tar.gz
...
cmake -DCMAKE_FIND_DEBUG_MODE=1 -DCMAKE_TOOLCHAIN_FILE=${BUILD_TOOLCHAIN_PATH} -DCMAKE_INSTALL_PREFIX=${BUILD_LIB_PREFIX} -D_CMAKE_MCOS_ROS_RTL=1 ../${SRC_DIR}/cmake_unofficial > ../${CMAKE_LOG} 2>&1
